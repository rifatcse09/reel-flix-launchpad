...
import { Play, User, BookOpen, Receipt, CreditCard, Lock, HelpCircle, LogOut, Gift, Users, Shield, LayoutDashboard, Banknote, Bell, BarChart3, Settings, DollarSign, Truck, Activity, HeartPulse, ClipboardList, FileCheck, Server, AlertTriangle, FileText, Database, Target, BookMarked, ShieldPlus, Recycle, Stethoscope, FlaskConical, Tags } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const adminItems: AdminMenuItem[] = [
  ...
  { title: "Pricing Control", url: "/admin/pricing", icon: Tags, permission: 'manage_settings' },
