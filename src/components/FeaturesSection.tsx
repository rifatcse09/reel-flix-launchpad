      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-card p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 animate-scale-in">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-cta/10 rounded-lg">
                <Smartphone className="h-8 w-8 text-cta" />
              </div>
            ...
            <div className="flex gap-4 mt-6">
              <Tablet className="h-6 w-6 text-cta/70" />
              <Smartphone className="h-6 w-6 text-cta/70" />
              <Tv className="h-6 w-6 text-cta/70" />
            </div>
          </div>
          ...
          <div className="bg-card p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 animate-scale-in" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-cta/10 rounded-full">
              <CheckCircle2 className="h-5 w-5 text-cta" />
              <span className="text-sm font-semibold text-cta">Cancel Anytime</span>
            </div>
          </div>
          ...
          <div className="bg-card p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 animate-scale-in md:col-span-2 lg:col-span-1" style={{ animationDelay: "0.2s" }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-cta/10 rounded-lg">
                <Wifi className="h-8 w-8 text-cta" />
              </div>
            ...
            <div className="flex gap-4 mt-6">
              <Wifi className="h-6 w-6 text-cta/70" />
              <Shield className="h-6 w-6 text-cta/70" />
            </div>
          </div>
        </div>
      </div>
